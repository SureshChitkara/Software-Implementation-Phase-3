 ...
 *****************************************SC**********************************
 ******************/
import javax.swing.*; /* SC Provides classes and interfaces for developing GUI components, such as buttons, text fields, and text areas. */
import java.awt.*; /* SC Provides classes for creating and managing GUI components, such as layouts and containers. */
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;
import java.sql.*; /* SC Provides classes for accessing and processing data stored in a relational database using SQL queries. */
import java.util.Calendar; /* SC Provides a set of methods for manipulating dates and times. */
import java.util.Date; /* SC Represents a specific instant in time with millisecond precision. */

public class LibraryManagementSystemGUI extends JFrame { /* SC Class implementation */
    /* SC Text field for entering books. */
    ...
    public LibraryManagementSystemGUI() { /* SC  It initializes the GUI window by setting its title to "Library Management System" */
        ...
        /* SC his method is expected to remove a book from the database based on the barcode provided by the user. */
...
/* SC This method is expected to handle the check-in process for the book specified by the user. */
    ...
    private void addBook() { /* SC adds a book to the database using the information provided by the user through the GUI components. */
